return function(STRINGS)
    ...
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_SLINGSHOTAMMO_GOLD = "Careful not to shoot your eye out with this..."
    ...
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_PORTABLECOOKPOT = "For your on the go cooking needs."
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_BERNIE_INACTIVE = "To protect you from the things that go bump in the night."
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_LEIF_IDOL = "For when you're itching for a fight."
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_OPALPRECIOUSGEM = "It's just a shiny rock, you want it?"
    STRINGS.RECIPE_DESC.WANDERINGTRADERSHOP_MAGICIAN_CHEST = "Oh look, a magic mailbox."
    ...
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT1 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT2 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT3 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT4 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT5 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT6 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT7 = ornamentString
    STRINGS.NAMES.COMBRINER_WINTER_ORNAMENT_LIGHT8 = ornamentString
    ...
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT1 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT2 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT3 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT4 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT5 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT6 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT7 = ornamentDesc
    STRINGS.RECIPE_DESC.COMBRINER_WINTER_ORNAMENT_LIGHT8 = ornamentDesc
    ...
    -- recipe for boss worm mouth
    STRINGS.NAMES.BOSS_WORM_MOUTH_RECIPE = STRINGS.NAMES.BOSS_WORM_MOUTH
    STRINGS.RECIPE_DESC.BOSS_WORM_MOUTH = "Is it really the mouth or the other end?"
end